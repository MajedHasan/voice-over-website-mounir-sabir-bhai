        ...
        <div class="container mx-auto lg:px-0 px-2 xl:max-w-[1240px] overflow-hidden ">
            ...
            <div class="lg:max-w-[700px] mx-auto rounded bg-slate-100 py-8 px-7 my-8">
                <form action="" class="flex w-full flex-col gap-4">
                    ...
                    <input type="number" class="w-full bg-slate-50 rounded outline-none p-2 border-[4px]" placeholder="Number">
                    <input type="text" class="w-full bg-slate-50 rounded outline-none p-2 border-[4px]" placeholder="Subject">

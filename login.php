        ...
        <div class="container mx-auto md:px-0 px-2">
            <div class="max-w-[500px] w-full mx-auto bg-gradient-to-r from-sky-100 via-purple-100 to-teal-100 rounded-lg shadow py-6 px-5">
                ...
                <div class="group w-full  relative mt-5">
                    ...
                    <input type="text" class="w-full bg-transparent outline-none border-2 border-sky-600 py-2 px-3 rounded">
                </div>
                <div class="group w-full  relative mt-5">
                ...
                <div class="group w-full  relative mt-5">
                    <button class="w-full border-2 border-sky-700 bg-sky-700 text-white hover:bg-slate-100 hover:text-sky-700 font-bold text-lg rounded py-2 px-5">LOG IN</button>
                </div>
            </div>
        </div>
    </section>
